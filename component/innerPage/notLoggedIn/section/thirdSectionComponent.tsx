            ...
            <main>
                <ContainerComponent className={'lg:flex-row flex-col-reverse flex items-center gap-[20px]'}>
                    <div className={'lg:w-[50%]'}>
                        ...
                        <ParagraphComponent noMarginBottom color={'text-gray-500'} className={'lg:text-right text-left'}>In the fast-paced rhythm of our modern lives, finding moments of stillness becomes increasingly essential for holistic well-being. Enter the world of meditation, a transformative practice that goes beyond the quieting of the mind. It's a journey inward, a conscious exploration of the self, and a commitment to mindfulness.</ParagraphComponent>
                    </div>
                    <Image
                        width={500}
                        height={200}
