...
// Creating and exporting calendar header component of calendar as default
export default function CalendarHeaderComponent({currentMonth, prevMonthHandler, nextMonthHandler}:propsType):ReactNode {
  // Returning JSX
  return (
